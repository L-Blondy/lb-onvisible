...
export function onVisible(nodeList, { class: addClass, duration, delay = 0, reverse = false, root = null } = {}) {
	...
	try {
		...
		const slideObs = new IntersectionObserver(slideCb, { threshold: 0.001, root });
